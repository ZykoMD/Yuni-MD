 ...
 *Powered By @${"12136852040".split("@")[0]}*`;
  ...
  let pp = await conn
    ...
    .catch((_) => "https://telegra.ph/file/fa050a700213f4da1e43e.jpg");
  const fkgif = {
    key: {
      fromMe: false,
    ...
    message: {
      extendedTextMessage: {
        text: `𝗭𝘆𝗸𝗼𝗕𝗼𝘁𝘇-𝗠𝗗 Whatsapp ʙᴏᴛ`,
        title: `𝗭𝘆𝗸𝗼𝗕𝗼𝘁𝘇-𝗠𝗗 Whatsapp ʙᴏᴛ`,
        jpegThumbnail: await (
          await fetch("https://telegra.ph/file/b6d6bbf2cd149982922c0.jpg")
        ).buffer(),
      },
    },
  };
...
┆         《 BOT INFO 》
┗┬──────────────┈ ⳹
┏┆⚘ 𝙱𝚘𝚝 𝙽𝚊𝚖𝚎 : 𝗭𝘆𝗸𝗼𝗕𝗼𝘁𝘇-𝗠𝗗
┆┆⚘ 𝙲𝚛𝚎𝚊𝚝𝚘𝚛
┆┆⚘ 𝙲𝚘𝚗𝚝𝚊𝚌𝚝 𝙾𝚠𝚗𝚎𝚛
┆┆http://wa.me/12136852040
┆┆⚘ 𝚃𝚊𝚗𝚐𝚐𝚊𝚕: ${date}
┆┆⚘ 𝙹𝚊𝚖: ${time} WIB
┆┆⚘ 𝙼𝚘𝚍𝚎: 「 ${mode}  」
┗┬──────────────┈ ⳹
