...
global.dfail = (type, m, conn) => {
  ...
  global.dfails = (jid, buffer, content, footer, button1, row1, button2, row2, quoted) => {
          conn.send2ButtonLoc(m.chat, fetch(fla + 'Kamu Belum Terima Rules Bot!').buffer(), `RULES 𝗭𝘆𝗸𝗼𝗕𝗼𝘁𝘇-𝗠𝗗
          1. Dilarang spam
          ...
          Hormat kami Staff 𝗭𝘆𝗸𝗼𝗕𝗼𝘁𝘇-𝗠𝗗
          `, '𝗭𝘆𝗸𝗼𝗕𝗼𝘁𝘇-𝗠𝗗 | ©𝗭𝘆𝗸𝗼𝗕𝗼𝘁𝘇-𝗠𝗗', 'Terima', '.terima', 'Tidak', '.tidak', m)
